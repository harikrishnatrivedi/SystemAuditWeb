            ...
            <div class="row">
                <div class="col-lg-6 col-md-6">
                    ...
                    <div class="panel-body">
                        <form:form id="addGroup" name="addGroup" role="form" method="POST" onsubmit="validateForm();" modelAttribute="deviceGroup">
                        	<fieldset>
		                        <div class="panel-body">
		                            	<div class="form-group has-error">
											<label class="control-label" for="inputError"><form:errors path="grpName" /></label>
										</div>
										<div class="form-group">
											<label>Group Name : </label>
		                                    <form:input path="grpName" class="form-control" placeholder="Enter Group Name." />
		                                </div>
		                                <div class="form-group">
											<label>Group Description : </label>
		                                    <form:password path="grpDescription" class="form-control" placeholder="Enter Group Description." />
		                                </div>
		                        </div>
		                        <div class="panel-footer">
		                            <button type="submit" id="btnSave" class="btn btn-success">Add Group</button>
		                        </div>
		                        </fieldset>
	                        </form:form>
                    </div>
